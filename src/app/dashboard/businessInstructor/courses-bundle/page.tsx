import CoursesBundleTable from "@/components/(bInstructor-cAdmin)/coursesBundle/CoursesBundleTable";
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <SectionHeader
        ...
        description=""
        leftContent="null"
        options={{ name: "link", content: "Create a New Bundle-Course", link: "/dashboard/businessInstructor/courses-bundle/create-new-course-bundle", type: "fill" }}
      />
