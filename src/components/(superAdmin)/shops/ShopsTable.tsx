...
import { NewShopTypes } from "@/app/dashboard/superAdmin/shop/page";
    ...
    <div className="inline-block min-w-full align-middle p-6 bg-white rounded-xl space-y-6">
      ...
      <div className="overflow-hidden">
        <table className="min-w-full text-lg">
          ...
          {/* T Body */}
          <tbody className="">
            {shops?.map((course: NewShopTypes, idx: number) => (
              <tr key={idx} className="border-b border-[#606060]">
                ...
                <td className="px-6 py-4">
                  <div>
                    <p className="text-nowrap">{course.author}</p>
                  </div>
                </td>
                {/* Category */}
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                  <div>
                    <p>{getFormatPrice(course.sales || 0)}</p>
                  </div>
                </td>
                {/* Rating */}
                <td className="px-6 py-4">
